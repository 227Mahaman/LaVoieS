...
/**
 * @var pages variable
 * @param actualites resultat de la requete
 * @param perPage
 * le nombre de page 
 */
$pages = ceil($actualites['0']['total']/$perPage);
                        ...
                        <div class="col-md-12 text-center">
                            <div class="site-block-27">
                                <ul>
                                    ...
                                    <li><a href="index.php?p=actualite&page=<?= $currentPage + 1 ?>" class="icon-keyboard_arrow_left"><?= $currentPage + 1 ?> &raquo;</a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
