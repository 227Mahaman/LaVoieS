            ...
            if (is_array($data) || is_object($data)) {
                ...
                <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
                    ...
                    <div class="text">
                        ...
                        <div class="text-white mb-3"><span class="text-black-opacity-05"><small>Publié le <?= $value['date']?></small><span class="sep">/</span> <small>Livre: <?= $fikr['livre'];?></small> <span class="sep">/</span> <a href="<?= $target.Manager::getData("files", "id", $value['chemin'])['data']['file_url'] ?>" download="<?= $value['titre']?>"><i class="fa fa-car"></i>Télécharger</a></span></div>
                        <div class="player">
