        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="featured-user  mb-5 mb-lg-0">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  <a href="#" class="d-flex align-items-center">
                    <img src="public/images/person_2.jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                ...
                <li>
                  <a href="#" class="d-flex align-items-center">
                    <img src="public/images/person_3.jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                ...
                <li>
                  <a href="#" class="d-flex align-items-center">
                    <img src="public/images/person_4.jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                ...
                <li>
                  <a href="#" class="d-flex align-items-center">
                    <img src="public/images/person_5.jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
                ...
                <li>
                  <a href="#" class="d-flex align-items-center">
                    <img src="public/images/person_6.jpg" alt="Image" class="img-fluid mr-2">
                    <div class="podcaster">
          ...
          <div class="col-lg-9">
            ...
            <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
              ...
              <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
                <div class="image" style="background-image: url('public/images/img_2.jpg');"></div>
                <div class="text">
                ...
                <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
                  <div class="image" style="background-image: url('public/images/img_3.jpg');"></div>
                  <div class="text">
                  ...
                  <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
                    <div class="image" style="background-image: url('public/images/img_4.jpg');"></div>
                    <div class="text">
                    ...
                    <div class="d-block d-md-flex podcast-entry bg-white mb-5" data-aos="fade-up">
                      <div class="image" style="background-image: url('public/images/img_5.jpg');"></div>
                      <div class="text">
